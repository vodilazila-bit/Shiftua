(()=>{
  ...
  style.id='portfolio-force-clean-style';
  style.textContent=`
    #work.zaisun-force-clean,#shift-case.shiftcase{padding:96px 0 34px!important;border-top:1px solid rgba(255,255,255,.14)!important}
    #work.zaisun-force-clean .rc-head,#shift-case .rc-head{display:grid!important;grid-template-columns:1fr!important;margin:0 0 34px!important}
    #work.zaisun-force-clean .rc-grid,#shift-case .rc-grid{display:grid!important;grid-template-columns:.72fr 1.28fr!important;gap:44px!important;align-items:start!important}
    #work.zaisun-force-clean .rc-copy,#shift-case .rc-copy{display:flex!important;flex-direction:column!important;gap:18px!important}
    #work.zaisun-force-clean .rc-copy h3,#shift-case .rc-copy h3{margin:0!important;color:#fff!important;font:600 clamp(30px,3.4vw,44px)/1.03 Manrope,sans-serif!important;letter-spacing:-.04em!important}
    #work.zaisun-force-clean .rc-sub,#shift-case .rc-sub{margin:0!important;max-width:34ch!important;color:#d8d8dc!important;font-size:18px!important;line-height:1.55!important}
    #work.zaisun-force-clean .rc-block,#shift-case .rc-block{margin-top:8px!important;padding:22px 24px!important;border:1px solid rgba(255,255,255,.13)!important;border-radius:20px!important;background:#111113!important}
    #work.zaisun-force-clean .rc-label,#shift-case .rc-label{margin-bottom:15px!important;color:#d9ff3f!important;font:700 11px/1 "DM Sans",sans-serif!important;letter-spacing:.17em!important;text-transform:uppercase!important}
    #work.zaisun-force-clean .rc-block ul,#shift-case .rc-block ul{margin:0!important;padding:0!important;list-style:none!important;display:grid!important;gap:11px!important}
    #work.zaisun-force-clean .rc-block li,#shift-case .rc-block li{position:relative!important;padding-left:25px!important;color:#e0e0e3!important;font-size:14.5px!important;line-height:1.55!important}
    #work.zaisun-force-clean .rc-block li:before,#shift-case .rc-block li:before{content:""!important;position:absolute!important;left:0!important;top:.72em!important;width:10px!important;height:2px!important;background:#d9ff3f!important}
    #work.zaisun-force-clean .rc-block li b{color:#fff!important;font-weight:700!important}
    #work.zaisun-force-clean .rc-link,#shift-case .rc-link{display:inline-flex!important;align-items:center!important;justify-content:space-between!important;gap:20px!important;width:max-content!important;min-width:210px!important;margin-top:6px!important;padding:14px 18px!important;border:1px solid rgba(255,255,255,.18)!important;border-radius:999px!important;background:#fff!important;color:#111!important;font-weight:800!important;text-decoration:none!important}
    #work.zaisun-force-clean .rc-link:hover,#shift-case .rc-link:hover{background:#d9ff3f!important;border-color:#d9ff3f!important;color:#111!important}
    ...
    #work.zaisun-force-clean .zai-slides{position:relative!important}
    #work.zaisun-force-clean .zai-slide{display:none!important}
    ...
    #work.zaisun-force-clean .zai-merchant-frame img{object-fit:contain!important;background:#fff!important}
    #work.zaisun-force-clean .zai-arrow{position:absolute!important;z-index:6!important;top:50%!important;transform:translateY(-50%)!important;display:grid!important;place-items:center!important;width:44px!important;height:44px!important;border:1px solid rgba(255,255,255,.22)!important;border-radius:50%!important;background:rgba(17,17,17,.72)!important;color:#fff!important;font:500 26px/1 Manrope,sans-serif!important;cursor:pointer!important;backdrop-filter:blur(8px)!important;transition:background .2s ease,transform .2s ease!important}
    #work.zaisun-force-clean .zai-arrow:hover{background:#d9ff3f!important;color:#111!important;transform:translateY(-50%) scale(1.05)!important}
    #work.zaisun-force-clean .zai-prev{left:12px!important}
    #work.zaisun-force-clean .zai-next{right:12px!important}
    #work.zaisun-force-clean .zai-dots{position:absolute!important;left:50%!important;bottom:16px!important;transform:translateX(-50%)!important;display:flex!important;gap:7px!important;z-index:6!important}
    ...
    @media(max-width:760px){
      ...
      #work.zaisun-force-clean .rc-head,#shift-case .rc-head{margin-bottom:28px!important}
      #work.zaisun-force-clean .rc-grid,#shift-case .rc-grid{display:flex!important;flex-direction:column!important;gap:24px!important}
      #work.zaisun-force-clean .zai-visual,#shift-case .shift-visual{order:1!important}
      #work.zaisun-force-clean .rc-copy,#shift-case .rc-copy{order:2!important;gap:18px!important}
      #work.zaisun-force-clean .rc-sub,#shift-case .rc-sub{font-size:16px!important;max-width:none!important}
      #work.zaisun-force-clean .rc-block,#shift-case .rc-block{padding:19px 18px!important;border-radius:18px!important}
      #work.zaisun-force-clean .rc-block li,#shift-case .rc-block li{font-size:14px!important;padding-left:23px!important}
      ...
      #work.zaisun-force-clean .zai-arrow{width:40px!important;height:40px!important;font-size:24px!important}
      #work.zaisun-force-clean .zai-prev{left:8px!important}
      #work.zaisun-force-clean .zai-next{right:8px!important}
    }
  `;
  ...
  conceptOpenStyle.textContent=`html body .concept-case .case-open{background:#fff!important;color:#101011!important;border:1px solid rgba(10,10,11,.20)!important;box-shadow:0 8px 28px rgba(0,0,0,.18)!important}html body .concept-case:hover .case-open{background:#fff!important;color:#101011!important}`;
  ...
  function applyZai(){
    ...
    if(!z)return;
    if(isClean(z)){loadZaiHero();bindZaiSlider();return}
    applying=true;
  ...
  function ensureShiftCase(){
    if(shiftApplying)return;
    const work=document.getElementById('work');
    if(!work)return;
    let shift=document.getElementById('shift-case');
    if(!shift){
      shiftApplying=true;
      shift=document.createElement('section');
      shift.id='shift-case';
      shift.className='realcase shiftcase';
      shift.innerHTML=SHIFT_HTML;
      work.insertAdjacentElement('afterend',shift);
      shiftApplying=false;
      return;
    }
    if(shift.previousElementSibling!==work){
      shiftApplying=true;
      work.insertAdjacentElement('afterend',shift);
      shiftApplying=false;
    }
  }
  function watchShiftCase(){
    ensureShiftCase();
    new MutationObserver(()=>ensureShiftCase()).observe(document.body,{childList:true,subtree:true});
  }
  ...
  function setupApproachDisclosure(){
    ...
    button.addEventListener('click',()=>{const open=!approach.classList.contains('is-open');approach.classList.toggle('is-open',open);button.setAttribute('aria-expanded',open?'true':'false');panel.setAttribute('aria-hidden',open?'false':'true')});
  }

  function enforceCostCtas(){
    let fix=document.getElementById('mobile-cost-cta-fix');
    if(!fix){
      fix=document.createElement('style');fix.id='mobile-cost-cta-fix';
    ...
    const submit=document.querySelector('#contact form button[type="submit"]');if(submit&&submit.textContent.trim()!=='Порахувати вартість')submit.textContent='Порахувати вартість';
  }
  function watchCostCtas(){enforceCostCtas();new MutationObserver(enforceCostCtas).observe(document.body,{childList:true,subtree:true,characterData:true})}

  function boot(){watchZai();watchShiftCase();watchCostCtas();setupApproachDisclosure()}
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
  [120,350,800,1500,2600].forEach(ms=>setTimeout(()=>{applyZai();ensureShiftCase()},ms));
